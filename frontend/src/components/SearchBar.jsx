...
const SearchBar = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6 bg-gray-100 rounded-md shadow-md flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
      {/* Check-in Date */}
